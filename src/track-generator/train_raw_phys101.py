...
from ema import (ensure_params_compatible, freeze, get_trainable_params,
                 update_ema)
from nn_latte_vae_rectangular import LatteVAE
...
def sample_latte_raw(
    ...
    query_points = (
        pixel_center_grid(TARGET_WIDTH, TARGET_HEIGHT)[
            2::4, 2::4][::trajectory_stride, ::trajectory_stride, :]  # type: ignore
    )
